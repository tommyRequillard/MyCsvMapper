...
// node_modules/ofx-js/ofx.js
var require_ofx = __commonJS({
  "node_modules/ofx-js/ofx.js"(exports, module) {
    var XmlParser = require_parser().Parser;
    function sgml2Xml(sgml) {
      return sgml.replace(/>\s+</g, "><").replace(/\s+</g, "<").replace(/>\s+/g, ">").replace(/<([A-Za-z0-9_]+)>([^<]+)<\/\1>/g, "<$1>$2").replace(/<([A-Z0-9_]*)+\.+([A-Z0-9_]*)>([^<]+)/g, "<$1$2>$3").replace(/<(\w+?)>([^<]+)/g, "<$1>$2</$1>");
    }
...
export default require_ofx();
/*! Bundled license information:

sax/lib/sax.js:
  (*! http://mths.be/fromcodepoint v0.1.0 by @mathias *)
*/
//# sourceMappingURL=ofx-js.js.map
